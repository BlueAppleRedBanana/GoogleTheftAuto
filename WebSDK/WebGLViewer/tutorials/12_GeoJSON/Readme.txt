world.json (and some extracted counties, such as switzerland.json)

Original Dataset provided by Bjorn Sandvik, thematicmapping.org
Converted to GeoJSON using ogr2ogr (gdal).
